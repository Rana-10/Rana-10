...
* **Relevant Coursework:** Deep Learning, Natural Language Processing, Data Mining, Parallel & Distributed Computing, Artificial Intelligence, Database Systems.
* **Programming Languages:** Python (Pandas, NumPy, Scikit-learn, PyTorch), SQL, JavaScript.
* **Machine Learning & AI:** Deep Learning (CNNs, RNNs), Adversarial ML (FGSM, PGD), Continual Fine-Tuning (LoRA, sparse LLMs), NLP, Multi-label Classification, Model Diagnostics.
